...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'booking.create.create': {
    roles: ['travel-agent', 'hotel-manager', 'customer-service-representative'],
    key: 'bookingId',
    tenantPath: [],
    userPath: [],
  },
  ...
  'hotel.update.update': { roles: ['travel-agent', 'hotel-manager'], key: 'hotelId', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['travel-agent'];
const customerRoles: string[] = ['customer'];
const tenantRoles: string[] = ['travel-agent', 'hotel-manager', 'customer-service-representative'];

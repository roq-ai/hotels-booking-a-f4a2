...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Hotels Booking Application`}</title>

        <meta
          name="description"
          content="Experience seamless travels with Hotels Booking Application. Book domestic and international hotels, from budget to luxury, at the best deals and discounts ever. Your journey to great accommodations starts here."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1625244724120-1fd1d34d00f6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxob3RlbHN8ZW58MHx8fHwxNjk1MjcyNjY1fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@ozzzyphotos?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Oswald Elsaboath`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`Hotels Booking Application`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless travels with Hotels Booking Application. Book domestic and international hotels, from budget to luxury, at the best deals and discounts ever. Your journey to great accommodations starts here.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Travel Agent" type="travel-agent" abilities={appConfig.ownerAbilities} />

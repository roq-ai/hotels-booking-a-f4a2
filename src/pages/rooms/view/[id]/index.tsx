            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('room', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/rooms/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Room Number" text={data?.room_number} />

                <FormListItem label="Room Type" text={data?.room_type} />

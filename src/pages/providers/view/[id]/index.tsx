...
import { HotelListPage } from 'pages/hotels';
            ...
            <FormWrapper wrapperProps={{ gap: 3, p: 4 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('provider', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/providers/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              <EntityImage entity="provider" entityId={id} />
              <List
                w="100%"
                css={{
                  '> li:not(:last-child)': {
              ...
              >
                ...
                <FormListItem label="Mobile" text={data?.mobile} />
